            ...
            >
              <div className="md:col-span-3">
                ...
                <EntitySelect
                  ...
                  options={materialOptions(line.material_id)}
              ...
              <div className="md:col-span-2 relative">
                <Label className={cn("text-xs font-semibold uppercase tracking-wider text-slate-500", lineLabelClass(idx))}>Precio *</Label>
                <MoneyInput
              ...
              <div className="md:col-span-1 md:text-right flex md:block items-center justify-between">
                <Label className={cn("text-xs font-semibold uppercase tracking-wider text-slate-500", lineLabelClass(idx))}>Utilidad</Label>
