    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="shadow-sm">
          <CardContent className="pt-6">
            <dl className="space-y-3 text-sm">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-3"><dt className="text-xs font-semibold uppercase tracking-wider text-slate-500">Cuenta</dt><dd><AccountLink id={movement.account_id}>{movement.account_name ?? "N/A (provision)"}</AccountLink></dd></div>
              {movement.third_party_name && <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-3"><dt className="text-xs font-semibold uppercase tracking-wider text-slate-500">Tercero</dt><dd><ThirdPartyLink id={movement.third_party_id}>{movement.third_party_name}</ThirdPartyLink></dd></div>}
              {movement.purchase_id && <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-3"><dt className="text-xs font-semibold uppercase tracking-wider text-slate-500">Compra vinculada</dt><dd><PurchaseLink id={movement.purchase_id}>Ver compra</PurchaseLink></dd></div>}
              {movement.sale_id && <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-3"><dt className="text-xs font-semibold uppercase tracking-wider text-slate-500">Venta vinculada</dt><dd><SaleLink id={movement.sale_id}>Ver venta</SaleLink></dd></div>}
              {movement.transfer_pair_id && <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 sm:gap-3"><dt className="text-xs font-semibold uppercase tracking-wider text-slate-500">Movimiento par</dt><dd><MoneyMovementLink id={movement.transfer_pair_id}>Ver par de transferencia</MoneyMovementLink></dd></div>}
